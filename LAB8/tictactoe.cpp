...
void playerTurn (char [][COLS]);
bool playerCanWin(char [][COLS], char);
void playerTurn(char [][COLS], char);
//!!!!!!!!!!  ADD FUNCTION PROTOTYPE FOR playerCanWin FUNCTION
//!!!!!!!!!!  ADD FUNCTION PROTOTYPE FOR playerTurn FUNCTION
...
//!!!!!!!!!!   WRITE THE displayBoard FUNCTION DEFINITION
...
//!!!!!!!!!!!!  ADD the playerTurn FUNCTION HEADER here
{
...
bool gameOver(char board[][COLS])
{
	...
	bool status;// The create status boolean flag
	 
	 if (playerWins(board, 'X') || playerWins(board, 'O'))
 
      status = true;// If either player has already won, game over.     
	
	else if (playerCanWin(board, 'X') || playerCanWin(board, 'O'))
 
      status = false;// Otherwise, if either player CAN STILL win, game NOT over.
	
	 else
 
      status = true;// Otherwise, it's a tie. Game over.
 
 
 
   return status;// return the status (either true or false)
}
...
//!!!!!!!!!!  WRITE THE FUNCTION HEADER FOR THE displayWinner FUNCTION
