/*
	...
	Date:
	Purpose:
			This program will read in the quantity of a particular item
			and its price.  It will then print out the total price.
			The input will come from a data file and the output will go
			to an output file.
*/
#include <iostream>
#include <fstream>
...
int main()
{
	...
	dataOut.open("bill.txt"); //this creates & opens the output file
	
	//Fill in the appropriate code in the blank below
	___________ << setprecision(2) << fixed << showpoint; //formatted output
	...
	//Fill in the output statement that prints the total bill to an output file.
